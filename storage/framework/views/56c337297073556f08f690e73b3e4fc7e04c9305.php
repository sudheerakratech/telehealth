    ...
    <div class="services-bottom row">
        ...
        <div class="col-md-7 wthree_services_bottom_left">
            <div class="wthree_services_bottom_left_grid">
                <div class="col-md-6 w3_agileits_services_bottom_l_grid">
                    <div class="agile_services_bottom_l_grid1">
                        <img src="<?php echo e(asset('images/g4.jpg')); ?>" alt=" " class="img-responsive" width="402.2px" />
            ...
            <div class="wthree_services_bottom_left_grid">
                ...
                <div class="col-md-6 w3_agileits_services_bottom_l_grid">
                    <div class="agile_services_bottom_l_grid1">
                        <img src="<?php echo e(asset('images/g2.jpg')); ?>" alt=" " class="img-responsive" height="270px"/>
                        <div class="w3_service_bottom_grid_pos">
                            <h3>Quality Care</h3>
                        </div>
                    </div>
                ...
                <div class="ziehharmonika">
                    ...
                    <div>
                        <div class="w3_agile_recipe-grid">
                            ...
                            <div class="col-md-6 col-sm-6 tab-image">
                                <img src="<?php echo e(asset('images/w1.jpg')); ?>" alt="Medicinal">
                            </div>
                    ...
                    <div>
                        <div class="w3_agile_recipe-grid">
                            ...
                            <div class="col-md-6 col-sm-6 tab-image two">
                                <img src="<?php echo e(asset('images/w2.jpg')); ?>" alt="Medicinal">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div>
                        <div class="w3_agile_recipe-grid">
                            ...
                            <div class="col-md-6 col-sm-6 tab-image">
                                <img src="<?php echo e(asset('images/w3.jpg')); ?>" alt="Medicinal">
                            </div>
                            <div class="col-md-6 col-sm-6 tab-info">
                    ...
                    <div>
                        <div class="w3_agile_recipe-grid">
                            ...
                            <div class="col-md-6 col-sm-6 tab-image two">
                                <img src="<?php echo e(asset('images/g2.jpg')); ?>" alt="Medicinal">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
    ...
    <div class="Department_girds_agileits">
        <div class="agile_team_grid">
            <div class="col-md-3 w3ls_banner_bottom_grid">
                <img src="<?php echo e(asset('images/p1.png')); ?>" alt=" " class="img-responsive" />
                <div class="overlay">
                    ...
                    <div class="w3-container">
                        <div id="id01" class="w3-modal w3-animate-opacity">
                            <div class="w3-modal-content w3-card-4">
                                ...
                                <div class="w3-container">
                                    <img src="<?php echo e(asset('images/Patient_Profile.JPG')); ?>" class="img-responsive">
                                </div>
                                <div class="w3-container">
                                    <p class="ab">
            ...
            <div class="col-md-3 w3ls_banner_bottom_grid">
                <img src="<?php echo e(asset('images/p2.jpg')); ?>" alt=" " class="img-responsive" />
                <div class="overlay">
                    ...
                    <div class="w3-container">
                        <div id="id02" class="w3-modal w3-animate-opacity">
                            <div class="w3-modal-content w3-card-4">
                                ...
                                <div class="w3-container">
                                    <img src="<?php echo e(asset('images/Medical_Consultancy.JPG')); ?>" class="img-responsive">
                                </div>
                                <div class="w3-container">
                                    <p class="ab">
            ...
            <div class="col-md-3 w3ls_banner_bottom_grid hvr-shutter-in-horizontal">
                <img src="<?php echo e(asset('images/p3.jpg')); ?>" alt=" " class="img-responsive" />
                <div class="overlay">
                    ...
                    <div class="w3-container">
                        <div id="id03" class="w3-modal w3-animate-opacity">
                            <div class="w3-modal-content w3-card-4">
                                ...
                                <div class="w3-container">
                                    <img src="<?php echo e(asset('images/Inoformation_Overflow.JPG')); ?>" class="img-responsive">
                                </div>
                                <div class="w3-container">
                                    <p class="ab">
            ...
            <div class="col-md-3 w3ls_banner_bottom_grid">
                <img src="<?php echo e(asset('images/p4.jpg')); ?>" alt=" " class="img-responsive" />
                <div class="overlay">
                    ...
                    <div class="w3-container">
                        <div id="id04" class="w3-modal w3-animate-opacity">
                            <div class="w3-modal-content w3-card-4">
                                ...
                                <div class="w3-container">
                                    <img src="<?php echo e(asset('images/Reports_Integration.JPG')); ?>" class="img-responsive">
                                </div>
                                <div class="w3-container">
                                    <p class="ab">
