...
class InstallController extends Controller {
    ...
    public function google_start(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $text = "<p>You're' here because you have not installed a Google OAuth2 Client ID file.  You'll need to set this up first before configuring AKRA TELEHEALTH.'</p>";
            if ($query) {
    ...
    public function install(Request $request, $type)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $data['panel_header'] = 'AKRA TELEHEALTH Installation';
            $items[] = [
                'name' => 'username',
            ...
            $data['content'] = '<p>Please fill out the entries to complete the installation of AKRA TELEHEALTH.</p><p>You will need to establish a Google Gmail account to be able to send e-mail from the system for patient appointment reminders, non-Protected Health Information messages, and faxes.</p>';
