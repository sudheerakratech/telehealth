...
class LoginController extends Controller {
    ...
    */
    ...
    public function accept_invitation(Request $request, $id, $username)
    {
    ...
    public function googleoauth(Request $request)
    {
        ...
        $google->setApplicationName('AKRA TELEHEALTH');
    ...
    public function login_uport(Request $request)
    {
        if ($request->has('uport')) {
            ...
            if ($user) {
                ...
                $return['message'] = 'Please set your email id in Uport to access AKRA HEALTH';
            }
        } else {
