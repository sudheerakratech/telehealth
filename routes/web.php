...
Route::get('singlepage', 'FrontEnd\FrontEndController@singlepage')->name('singlepage');
...
Route::post('delete-appointment', 'FrontEnd\AppointmentController@deleteAppointment')->name('delete-appointment');
...
//paypal
Route::get('process_payment', 'PaypalController@index');
Route::get('process_paid', 'PaypalController@processPaid');
Route::post('session_watcher', 'PaypalController@sessionWatcher');
