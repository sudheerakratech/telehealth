                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Dr. James Francis</h4>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Robert Lewis</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                    ...
                    <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                        <div class="mainflip">
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Dr. Gurcharan Das</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Frank D'Souza</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="social-icon text-xs-center" target="_blank" href="#">
                    ...
                    <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                        <div class="mainflip">
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Dr. Andy Wong</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Suman Das</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="social-icon text-xs-center" target="_blank" href="#">
                    ...
                    <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                        <div class="mainflip">
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Dr Frank Gardener</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Kumar Natarajan</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="social-icon text-xs-center" target="_blank" href="#">
                    ...
                    <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                        <div class="mainflip">
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Annie Joseph</h4>
                                        <p class="card-text"> Profile Details have been hidden for now to ensure confidentiality ! </p>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="social-icon text-xs-center" target="_blank" href="#">
                    ...
                    <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                        <div class="mainflip">
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Dr. Farook Sheikh</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card-body text-center mt-4">
                                        <h4 class="card-title">Dr. Ram Kumar</h4>
                                        <p class="card-text">Profile Details have been hidden for now to ensure confidentiality !</p>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a class="social-icon text-xs-center" target="_blank" href="#">
